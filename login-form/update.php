                        ...
                        <div class="card-body">
                            ...
                            <form id="registrationForm" enctype="multipart/form-data" class="needs-validation"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control custom-name" name="firstNameInput"
                                                id="firstNameInput" required value="<?php
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control custom-name" name="lastNameInput"
                                                id="lastNameInput" required value="<?php
                                                if (isset($_GET['price'])) {
                                                    echo $_GET['price'];
                                                } ?>">
                                            <div class="invalid-feedback">
                                ...
                                <select class="form-select" id="category" name="category"
                                    ...
                                    <option <?php if (isset($_GET['category']) && $_GET['category'] === 'On the stick food')
                                        echo 'selected'; ?> value="On the stick food">On the stick food</option>
                                    <option <?php if (isset($_GET['category']) && $_GET['category'] === 'Drinks')
                                        echo 'selected'; ?> value="Drinks">Drinks
                                    </option>
                                    <option <?php if (isset($_GET['category']) && $_GET['category'] === 'Food')
                                        echo 'selected'; ?> value="Food">Food</option>
                                </select>
