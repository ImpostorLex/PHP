...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($has_error) {
        ...
        $result_blog = updateBlog($title, $body, $stid, $id);
                ...
                <?php if (isset($result)): ?>
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="body" name="body" rows="6" cols="50"
                                required><?php echo $result['body'] ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="Username" class="form-label">Editing as student number: </label>
